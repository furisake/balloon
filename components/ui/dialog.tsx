  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed left-1/2 top-1/2 z-50 max-h-[85vh] w-[min(92vw,32rem)] -translate-x-1/2 -translate-y-1/2 overflow-auto rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-xl",
          className,
        )}
      >
